...
describe('V1 Router', () => {
  ...
  it('Can create a new food item', async () => {
    ...
    const response = await mockRequest.post('/api/v1/food')
      .send(testFood)
  ...
  it('returns a list of food items', async () => {
    await mockRequest.post('/api/v1/food')
      .send(testFood2)
      .set('Authorization', `bearer ${token}`);
  ...
  it('returns a single food by id', async () => {
    const response = await mockRequest.get('/api/v1/food/2')
      .set('Authorization', `bearer ${token}`);
  ...
  it('Can update a food item', async () => {
    ...
    const foodObject = response.body;
    console.log('🚀 ~ file: v1-router.test.js:95 ~ it ~ foodObject', foodObject);
  ...
  it('Can delete a food item', async () => {
    ...
    const foodObject = response.body;
    console.log('🚀 ~ file: v1-router.test.js:108 ~ it ~ foodObject', foodObject);
